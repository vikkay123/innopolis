...
import ru.innopolis.vikkay.stc.Part_3.lesson_16.dao.BookDao;
import ru.innopolis.vikkay.stc.Part_3.lesson_16.dao.BookDaoJdbc;
    ...
    public static void main(String[] args) throws SQLException {
        ...
        try (Statement statement = connectionManager.ConnectionManagerDB()
             ...
             ResultSet resultSetBooks = statement.executeQuery("SELECT * FROM books")) // Выполнение запроса
         {
            ...
            // Работа с БД через ссылку (bookDao - паттерн Фасад) на объект (BookDaoJdbc())
