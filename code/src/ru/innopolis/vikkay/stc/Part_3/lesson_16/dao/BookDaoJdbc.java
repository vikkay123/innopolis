...
import ru.innopolis.vikkay.stc.Part_3.lesson_16.BookDB;
 ...
 *  Класс BookDaoJdbc
 *
 *  Построен на базе паттерна Фасад.
 *  Прячет всю логику (подключение к базе, работу с базой)
 *  от внешнего пользователя.
 *  Работа с БД только через вызов его методов.
 *
...
public class BookDaoJdbc implements BookDao {   // Структурный паттерн Фасад
