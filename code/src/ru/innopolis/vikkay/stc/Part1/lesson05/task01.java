...
public class task01 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        char punkt;
        AddListAnimal list = new AddListAnimal();
        ...
        switch (punkt) {
            ...
            case '2':
                ...
                System.out.println();
                list.getAnimalList().sort(new PersonComparator()); // сортировка
                System.out.println("Картотека после сортировки: ");

                for (Person p : list.animalList) {
            ...
            case '4':
                ...
                System.out.println();
                System.out.printf("Картотека после добавления строки №4 ");
                list.arrayToMap(new Person(4,"Крылова Ирина", "Киса", 4, SexAnimal.самка.toString(), 4.3));
                System.out.println();
                break;
